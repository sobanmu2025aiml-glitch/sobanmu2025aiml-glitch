...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=2E9EF7&center=true&vCenter=true&width=435&lines=Full+Stack+Developer;Open+Source+Enthusiast;Always+Learning+New+Things" alt="Typing SVG" />
</p>
...
- ⚡ Fun fact: **SOMETHING_INTERESTING**
...
<!--
  ⬆️ To enable the animated snake:
  1. Go to Settings > Actions > General in the same-name repo, enable workflows.
  2. Create .github/workflows/snake.yml with the Platane/snk action (see comments below the file).
  3. Push once, then GitHub Actions will generate/update the SVG automatically.
-->
